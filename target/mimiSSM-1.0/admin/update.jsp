...
<script type="text/javascript">
	function myclose() {
		window.location="${pageContext.request.contextPath}/product/splitSelect.action";
		//window.close();
	}
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/product/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;"><img src="/image_big/${product.pImage}" width="100px" height="100px" ></div><br><br><br><br>
