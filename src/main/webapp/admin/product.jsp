...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            商品名称：<input name="selectName" id="selectName" value="${vo.pName}">&nbsp;&nbsp;&nbsp;
            商品类型：<select name="selectTypeId" id="selectTypeId">
            ...
            价格：<input name="selectMinPrice" id="selectMinPrice" value="${vo.minPrice}">-<input name="selectMaxPrice" id="selectMaxPrice" value="${vo.maxPrice}">
...
<script type="text/javascript">
    ...
    function one(pId, ispage) {
        location.href = "${pageContext.request.contextPath}/product/one.action?pId=" + pId + "&page=" + ispage;
    }
</script>
<!--分页的AJAX实现-->
<script type="text/javascript">
    ...
    function selectCondition() {
        ...
        //异步ajax分页请求
        $.ajax({
            url:"${pageContext.request.contextPath}/product/selectCondition.action",
            data:{"pName":selectName,"typeId":selectTypeId,"minPrice":selectMinPrice,"maxPrice":selectMaxPrice},
            type:"post",
            success:function () {
                //重新加载分页显示的组件table
                //location.href---->http://localhost:8080/admin/login.action
